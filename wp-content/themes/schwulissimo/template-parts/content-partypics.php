...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<header class="entry-header clearfix">
            ...
            <p class="beside-image">EINE<?php echo $author->avatar; ?></p><p class="beside-image">GALERIE VON</p>
	...
	<div class="entry-content">
        ...
        <?php schwulissimo_partypics_single_location_metabox() ?>
        <?php schwulissimo_partypics_single_map() ?>
